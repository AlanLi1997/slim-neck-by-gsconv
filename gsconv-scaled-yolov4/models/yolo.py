...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in [nn.Conv2d, Conv, Bottleneck, SPP, DWConv, MixConv2d,
                 Focus, CrossConv, BottleneckCSP, BottleneckCSP2, SPPCSP, VoVCSP, C3,
                 GSBottleneck, GSConv, GSBottleneckC, VoVGSCSP, VoVGSCSPC
                 ]:
            c1, c2 = ch[f], args[0]
            ...
            args = [c1, c2, *args[1:]]
            if m in [BottleneckCSP, BottleneckCSP2, SPPCSP, VoVCSP, C3, VoVGSCSP, VoVGSCSPC]:
                args.insert(2, n)
                n = 1
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='SNc-yolov4-p5.yaml', help='model.yaml')
